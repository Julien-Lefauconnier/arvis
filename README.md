...
> **Status: `0.1.0b7` (beta).** The public surface (`arvis.__all__` and the
...
| Axis | Value | Meaning |
|------|-------|---------|
| Package version | `0.1.0b7` | the distributed artifact (PEP 440) |
...
**`0.1.0b7` (beta)**: actively developed with a validation-first engineering
